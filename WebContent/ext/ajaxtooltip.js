...
var ajaxtooltip={
	...
	loadingHTML: '<div style="font-style:italic"><img src="'+CONTEXT_PATH+'/themes/images/loading.gif" />加载...</div>',
...
jQuery(document).ready(function(){
	...
	$('a[title*=ajax]').each(function(index){ //find all links with "title=ajax:" declaration
