...
<%
	...
	try{
		List<Map<String,Object>> fylist = bi09.queryForList("select DM_CITY DM,NAME_CITY MC from DM_CITY where DM_CITY like '"+fydm+"%' and isnull(SFJY,'0') <> '1' order by DM_CITY");
		...
		sql += Constant.fcmap.get(flag).replace("@kssj@",kssj).replace("@jssj@",jssj);
		sql += " group by FYDM ";
