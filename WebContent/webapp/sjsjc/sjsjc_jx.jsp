...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		initTree([{'contentid':'ywcbContent','treeid':'ywcbTree','inputid':'ywcb','selected':['<%=fydm%>'],'expand':true,'hide':false,
			'valueid':'ywcbValue','onClick':ywcbClick,'url':contextPath+'/webapp/sjsjc/sjsjc_tree_jx.jsp?'+"FYDM="+fydm}]);
	...
	function loadTable(start,first){
		...
		loadData('sjsjc_data_jx.jsp',{'kssj':kssj,'jssj':jssj,'FYDM':fydm},function(json){
			$("#tableContent").unmask();
