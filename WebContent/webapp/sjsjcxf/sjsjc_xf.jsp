...
<script type="text/javascript">
	...
	$(document).ready(function(){
		initTree([{'contentid':'ywcbContent','treeid':'ywcbTree','inputid':'ywcb','selected':['<%=fydm%>'],'expand':true,'hide':false,
			'valueid':'ywcbValue','onClick':ywcbClick,'url':contextPath+'/webapp/sjsjcxf/sjsjc_xf_tree.jsp?'+"FYDM="+fydm}]);
	...
	function loadTable(start,first){
		...
		loadData('sjsjc_xf_data.jsp',{'FYDM':fydm},function(json){
			$("#tableContent").unmask();
	...
	function doFc(dm,flag){
		window.open('fc/sjc_xf_fc.jsp?fy='+dm+'&flag='+flag);
	}
</script>
</html>