...
<table id="btTable" valign="top" width="100%" height="50"   style="text-align:left;font-size:12px;border:1px solid #99BBE8;" bgcolor=#E8F7FF>
		<tr height="25" >
		  <td  colspan="5" align="center" style="border:1px solid #99BBE8;font-size:15pt;"><span color=#429EE7>数据中心解析入库质量报告</span>
		  </td>
		</tr>
		<tr height="25">
			<%--<td width="340">
		...
		--%><td><div id="totalInfo" style="padding-left:400"></div></td>
		<td align="right">
		 <input type="button"  value="反查案件" onclick="downLoad();" icon="icon-excel" />
		</td>
		</tr>	
</table>
</div>
...
<script type="text/javascript">
function downLoad(){
//	window.open("fc/fc.jsp?id="+fydm+"&cxsj1="+$('#larq1').val()+"&cxsj2="+$('#larq2').val());
	window.open("fc/fc.jsp?id="+fydm);
}
</script>
</html>