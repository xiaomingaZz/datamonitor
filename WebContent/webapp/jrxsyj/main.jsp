...
<table id="btTable" valign="top" width="100%" height="50"   style="text-align:left;font-size:12px;border:1px solid #99BBE8;" bgcolor=#E8F7FF>
		<tr height="25" >
		  <td  colspan="4" align="center" style="border:1px solid #99BBE8;font-size:15pt;"><span color=#429EE7>数据中心每日上报监控</span>
		  </td>
		</tr>
		<tr height="25">
			<td width="340">
		...
		<td>
		<input type="checkbox" id="refreshC" onclick="doRefresh()" >定时刷新
		</td>
		<td align="right">
		<!-- 
...
var refreshId;
function doRefresh(){
	if($('#refreshC').attr('checked')){
		refreshId=setInterval("doSearchrefresh()",300000);
		}
	else {
