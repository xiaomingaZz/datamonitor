...
<table id="btTable" valign="top" width="100%" height="50"   style="text-align:left;font-size:12px;border:1px solid #99BBE8;" bgcolor=#E8F7FF>
		<tr height="25" >
		  <td  colspan="5" align="center" style="border:1px solid #99BBE8;font-size:15pt;"><span color=#429EE7>数据中心文书质检报告</span>
		  </td>
		</tr>
		<tr height="25">
			<td width="440">
			<span style="height:20">&nbsp;&nbsp;结案日期：</span> 
